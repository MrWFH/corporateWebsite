...
export const NEWS_LIST: NewsItem[] = [
  {
    id: "1",
    title: "元宇宙科技 发布新一代 AI 大模型平台，赋能千行百业智能化",
    summary:
      "在 2025 年度技术峰会上，元宇宙科技 正式发布了全新的企业级 AI 大模型平台，支持多模态理解、智能生成和行业知识注入，为企业客户提供开箱即用的 AI 能力。",
    date: "2025-12-15",
    category: "company",
    featured: true,
  },
  {
    ...
    summary:
      "在中国信息通信研究院主办的年度评选中，元宇宙科技 凭借在云计算和人工智能领域的持续创新，荣获「年度最具创新力科技企业」称号。",
    date: "2025-11-28",
    category: "company",
  },
  {
  ...
  },
  {
    ...
    summary:
      "检索增强生成（RAG）已成为企业 AI 应用的核心架构。本文分享了 元宇宙科技 在构建大规模 RAG 系统中的技术选型与优化实践。",
    date: "2025-11-10",
    category: "tech",
  },
  {
    id: "5",
    title: "元宇宙科技 云平台通过国家等保三级认证",
    summary:
      "近日，元宇宙科技 云平台正式通过国家网络安全等级保护三级认证，标志着平台在安全合规方面达到了金融级标准。",
    date: "2025-10-25",
    category: "company",
  },
  {
  ...
  },
  {
    ...
    summary:
      "元宇宙科技 与某大型国有银行达成战略合作，共建智能风控平台，实现贷前、贷中、贷后全流程智能化管控。",
    date: "2025-09-20",
    category: "company",
  },
  {
  ...
  {
    id: "10",
    title: "元宇宙科技 成都研发中心正式启用，西南布局再进一步",
    summary:
      "元宇宙科技 成都研发中心于近日正式投入运营，将重点承担 AI 算法研发和行业解决方案孵化工作，进一步完善全国研发网络布局。",
    date: "2025-08-28",
    category: "company",
  },
  {
  ...
  },
  {
    ...
    summary:
      "由 元宇宙科技 联合多家研究机构编撰的《2025 中国企业数字化转型白皮书》正式发布，全面梳理了各行业数字化转型的现状、挑战与路径。",
    date: "2025-08-01",
    category: "industry",
  },
];
